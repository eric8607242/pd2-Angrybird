...
superbird1::superbird1(float x, float y, float radius, QTimer *timer, QPixmap pixmap, b2World *world, QGraphicsScene *scene,float density):GameItem(world)
{
    // Set pixmap
...
void superbird1::setLinearVelocity(b2Vec2 velocity)
{
    g_body->SetLinearVelocity(velocity);
}

void superbird1::supergo()
{
     b2Vec2 velocity;
     velocity = b2Vec2(0,-30);
     g_body->SetLinearVelocity(velocity);
}
bool superbird1::disapp()
{
    b2Vec2 ve;
